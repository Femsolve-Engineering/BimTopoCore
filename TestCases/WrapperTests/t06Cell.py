...
def test_06cell() -> bool:
    ...
    assert isinstance(cell_b0, coreCell), "Cell.Box. Should be coreCell"
    # test 2
    cell_b = Cell.Box()                                                                # without optional inputs
    assert isinstance(cell_b, coreCell), "Cell.Box. Should be coreCell"
    # plot geometry
    ...
    assert isinstance(cell_prism, coreCell), "Cell.Prism. coreCell"
    # test 2
    ...
    assert isinstance(cell_f, coreCell), "Cell.ByFaces. coreCell"
    # test 2
    ...
    assert isinstance(cell_s, coreCell), "Cell.ByShell. coreCell"
    # plot geometry
    ...
    assert isinstance(cell_tf, coreCell), "Cell.ByThickenedFace. coreCell"
    # test 2
    ...
    assert isinstance(cell_ts, coreCell), "Cell.ByThickenedShell. coreCell"
    # plot geometry
    ...
    assert isinstance(cell_w, coreCell), "Cell.ByWires. coreCell"
    # test 2
    ...
    assert isinstance(cell_wc, coreCell), "Cell.ByWiresCluster. coreCell"
    # test 2
    ...
    assert isinstance(cell_c, coreCell), "Cell.Cone. coreCell"
    # test 2
    ...
    assert isinstance(cell_cy, coreCell), "Cell.Cylinder. coreCell"
    # test 2
    ...
    assert isinstance(eb_cell, coreShell), "ExternalBoundary. coreShell"
    # plot geometry
    ...
    assert isinstance(cell_hp, coreCell), "Cell.Hyperboloid. coreCell"
    # test 2
    ...
    assert isinstance(iv_cell, coreVertex), "Cell.Hyperboloid. coreVertex"
    # test 2
    iv_cell1 = Cell.InternalVertex(cell_c, tolerance=0.001)                                   # with optional inputs
    assert isinstance(iv_cell1, coreVertex), "Cell.Hyperboloid. coreVertex"
    ...
    assert isinstance(pipe_cell, coreCell), "Cell.Pipe. Should be a Cell"
    ...
    assert isinstance(cell_sphere, coreCell), "Cell.Sphere. coreCell"
    # test 2
    ...
    assert isinstance(cell_torus, coreCell), "Cell.Torus. coreCell"
    # test 2
    """TypeError: 'NoneType' object is not iterable"""
