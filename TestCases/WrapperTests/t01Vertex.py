...
def test_01vertex() -> bool:
    try:
        ...
        # test 1
        print("TestToDo-Vertex: Skipping Vertex.AreIpsilateralCluster tests as some required method were not available at the time of writing.")
        ...
        # test 1
        print("TestToDo-Vertex: Skipping Vertex.AreIpsilateralCluster tests as some required method(s) were not available at the time of writing.")
        # status = Vertex.AreOnSameSideCluster(Cluster.ByTopologies(v_list1), face=f)
        # assert status == False, "Vertex.AreIpsilateral. Should be False"
        # test 2
        print("TestToDo-Vertex: Skipping Vertex.AreOnSameSideCluster tests as some required method(s) were not available at the time of writing.")
        ...
        # test 2
        print("TestToDo-Vertex: Skipping Cell.Prism tests as some required method(s) were not available at the time of writing.")
        ...
        # test 1
        print("TestToDo-Vertex: Skipping CellComplex.Prism related tests as some required method(s) were not available at the time of writing.")
        ...
        # test 1
        print("TestToDo-Vertex: Skipping Cluster.ByTopologies related tests as some required method(s) were not available at the time of writing.")
        ...
        print("TestToDo-Vertex: Did not use Face.Rectangle because some required method were not available at the time of writing.")
        ...
        f = coreFace.by_edges([base_edge1, base_edge2, base_edge3, base_edge4])
        print("TestToDo-Vertex: Did not use Vertex.Project because some required method(s) were not available at the time of writing (Topology.Slice).")
